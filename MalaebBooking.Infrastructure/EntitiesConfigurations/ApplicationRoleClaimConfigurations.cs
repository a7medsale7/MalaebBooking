...
public class ApplicationRoleClaimConfigurations : IEntityTypeConfiguration<IdentityRoleClaim<string>>
{
    public void Configure(EntityTypeBuilder<IdentityRoleClaim<string>> builder)
    {
        ...
        var ownerPermissions = new List<string>
        {
            ...
            // 👈 صلاحية رؤية بروفايله الخاص للتأكد من حالة التوثيق
            Permissions.OwnerProfiles_View
        };
        ...
        var playerPermissions = new List<string>
        {
            ...
            // 👈 صلاحية التقديم ليصبح صاحب ملعب ورؤية حالة طلبه
            Permissions.OwnerProfiles_Apply,
            Permissions.OwnerProfiles_View
        };
