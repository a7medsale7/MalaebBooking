...
namespace MalaebBooking.Infrastructure.Migrations
{
    ...
    [Migration("20260418171325_UpdatePemissions")]
    partial class UpdatePemissions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MalaebBooking.Domain.Entities.ScheduleRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ExcludedHours")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("MalaebBooking.Domain.Entities.StadiumOwnerProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("NationalIdImageBack")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("NationalIdImageFront")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("OwnershipContractImage")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("Status")
                        .HasColumnType("int");

                    b.Property<string>("TradeLicenseImage")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("StadiumOwnerProfiles");
                });
            ...
            modelBuilder.Entity("MalaebBooking.Domain.Entities.Stadium", b =>
                {
                    b.HasOne("MalaebBooking.Domain.Entities.StadiumOwnerProfile", "OwnerProfile")
                        .WithMany("Stadiums")
            ...
            modelBuilder.Entity("MalaebBooking.Domain.Entities.StadiumOwnerProfile", b =>
                {
                    b.HasOne("MalaebBooking.Domain.Entities.ApplicationUser", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedById");

                    b.HasOne("MalaebBooking.Domain.Entities.ApplicationUser", "User")
                        .WithOne("StadiumOwnerProfile")
                        .HasForeignKey("MalaebBooking.Domain.Entities.StadiumOwnerProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MalaebBooking.Domain.Entities.TimeSlot", b =>
                {
                    b.HasOne("MalaebBooking.Domain.Entities.ScheduleRule", "ScheduleRule")
            ...
            modelBuilder.Entity("MalaebBooking.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("StadiumOwnerProfile");
                });
